...
Each function is a plain async def that receives `cwd` explicitly for path
resolution. These are NOT decorated with @tool -- they are internal to
openstream and called by the DirectClient's tool-dispatch loop.
"""
